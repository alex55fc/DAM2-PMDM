...
public class AutorPremioController implements Serializable {
    ...
    public AutorPremio getSelected() {
        if (current == null) {
            ...
            current.setAutorPremioPK(new Modelos.AutorPremioPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public AutorPremio getAutorPremio(Modelos.AutorPremioPK id) {
    ...
    public static class AutorPremioControllerConverter implements Converter {
        ...
        Modelos.AutorPremioPK getKey(String value) {
            Modelos.AutorPremioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new Modelos.AutorPremioPK();
        ...
        String getStringKey(Modelos.AutorPremioPK value) {
