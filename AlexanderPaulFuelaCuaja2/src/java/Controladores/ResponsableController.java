...
public class ResponsableController implements Serializable {
    ...
    //hecho para AAejer1_2
    private Sede sede;
    private List<Sederesponsable> responsablesList;
    ...
    public List<Sederesponsable> getResponsablesList() {
        return responsablesList;
    }

    public void setResponsablesList(List<Sederesponsable> responsablesList) {
    ...
    //creado para AAejer1
    public SelectItem[] getItemsPorSedes() {
        //return JsfUtil.getSelectItems(ejbFacade.findAll(), true);
        return getSelectResponsable(ejbFacade.responsablesSedesOrdenados(), false);
    }
    public Responsable getResponsable(java.lang.Integer id) {
        return ejbFacade.find(id);
    }
//añadido por AAejer1
    @FacesConverter(forClass = Responsable.class, value="responsableConverted")
    ...
    //metodos para AAejer1_2
    public void cargarListaResponsables(){
       responsablesList = ejbFacade.responsablesPorSedes(sede);
    
    }
    public static SelectItem[] getSelectResponsablee(List<Responsable> entities, boolean selectOne) {
    SelectItem[] items = new SelectItem[entities.size()];
    int i = 0;
