...
public class EnvioController implements Serializable {
    ...
    private List<Envio> listaProyecto;
    ...
    public List<Envio> getListaProyecto() {
        return listaProyecto;
    }

    public void setListaProyecto(List<Envio> listaProyecto) {
    ...
    public void cargarLista(){
       listaProyecto = ejbFacade.lista(proyecto);
    
    }
    public Double calcularSumaCantidad(double sumaa) {
        // Implementa la lógica para obtener la suma de la cantidad de envíos
        // Puedes usar tu EnvioFacade o cualquier otra lógica que tengas para sumar la cantidad de envíos
        // Aquí un ejemplo básico:
        Double suma = 0.0;
        for (Envio envio : listaProyecto) {
            suma += envio.getCantidad();
        }
        return suma;
    }    
