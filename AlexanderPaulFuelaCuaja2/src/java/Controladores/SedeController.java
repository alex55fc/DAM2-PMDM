...
public class SedeController implements Serializable {
    ...
    //hecho para EjerExamen1
    private Inspectoria inspectoria;
    private List<Sede> listaInspectoria;
    ...
    public List<Sede> getListaInspectoria() {
        return listaInspectoria;
    }

    public void setListaInspectoria(List<Sede> listaInspectoria) {
        this.listaInspectoria = listaInspectoria;
    }
    
    
    //hecho para AAejer1
    private Responsable responsable;
    private List<Sederesponsable> sedesList;
    ...
    public List<Sederesponsable> getSedesList() {
        return sedesList;
    }

    public void setSedesList(List<Sederesponsable> sedesList) {
    ...
    public SelectItem[] getItemsPorResponsables() {
        return getSelectSede(ejbFacade.sedesResponsablesOrdenados(), false);
    }

    public Sede getSede(java.lang.String id) {
        return ejbFacade.find(id);
    }
    //añadido por AAejer1_2
    @FacesConverter(forClass = Sede.class, value="sedeConverted")
    ...
    public static SelectItem[] getSelectSede(List<Sede> entities, boolean selectOne) {
    ...
    public void cargarListaSedes(){
       sedesList = ejbFacade.sedesPorResponsable(responsable);
    
    }
    /*
    //hecho para ExamenEjer1
    public void cargarLista(){
        listaInspectoria = ejbFacade.SedePorInspectoria(inspectoria); 
    }
    */
}
